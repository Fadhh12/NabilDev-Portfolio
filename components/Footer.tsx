...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-8 bg-inverse-surface border-t border-outline/20 snap-end">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <a href="https://github.com/Fadhh12" target="_blank" rel="noreferrer" className="text-[12px] font-bold tracking-[0.08em] uppercase text-outline-variant hover:text-primary-light transition-colors">
            GitHub
          </a>
          <a href="https://www.linkedin.com/in/nabil-fadhlur-rahman-686794320/" target="_blank" rel="noreferrer" className="text-[12px] font-bold tracking-[0.08em] uppercase text-outline-variant hover:text-primary-light transition-colors">
            LinkedIn
          </a>
